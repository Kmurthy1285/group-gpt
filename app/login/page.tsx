      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Create group chats with friends and ChatGPT
          </p>
        </div>
        ...
        <div style={{
          ...
          <ul style={{
            ...
            <li>Create named group chats</li>
            <li>Invite friends with shareable links</li>
            <li>Chat with ChatGPT in every room</li>
